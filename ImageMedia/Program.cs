    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (Continue)
            {
                ...
                Console.WriteLine("Choose algorithm: ('1' -- RLE, '2' --LZW, '3' -- Standart Encoding)");
                int choise = 0;
                try
                {
                ...
                DifferenceResult rgb = new DifferenceResult();
                ...
                switch (choise)
                {
                    case 2:
                        ...
                        res = Algo.TiffLzwTransformation(image, $"{outputPath}/{fileName}.tiff");

                        Console.WriteLine(res.ToString());

                        Console.ResetColor();

                        rgb = Algo.SetDifference(image, res.CompressedImage, true, false, false);
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine($"= Red: { rgb.RgbDifference.R}");

                        Console.ResetColor();
                        rgb.WriteDifferenceImage($@"C:\ImageMedia\ImageMedia\Results\DifferenceImages\Red\{fileName}.jpg");

                        Console.WriteLine("=============================================="); 

                        rgb = Algo.SetDifference(image, res.CompressedImage, false, true, false);
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine($"= Green: { rgb.RgbDifference.G}");
                        Console.ResetColor();
                        rgb.WriteDifferenceImage($@"C:\ImageMedia\ImageMedia\Results\DifferenceImages\Green\{fileName}.jpg");

                        Console.WriteLine("==============================================");


                        rgb = Algo.SetDifference(image, res.CompressedImage, false, false, true);
                        Console.ForegroundColor = ConsoleColor.Blue;
                        Console.WriteLine($"= Blue: { rgb.RgbDifference.B}");
                        Console.ResetColor();
                        rgb.WriteDifferenceImage($@"C:\ImageMedia\ImageMedia\Results\DifferenceImages\Blue\{fileName}.jpg");

                        Console.WriteLine("==============================================");

                        rgb = Algo.SetDifference(image, res.CompressedImage, true, true, true);
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine($"= Red: { rgb.RgbDifference.R}");
                        Console.ForegroundColor = ConsoleColor.Green;
                        Console.WriteLine($"= Green: { rgb.RgbDifference.G}");
                        ...
                        rgb.WriteDifferenceImage($@"C:\ImageMedia\ImageMedia\Results\DifferenceImages\AllColors\{fileName}.jpg");
                    ...
                    case 3:
                        ...
                        res = Algo.JpegTransformation(image, $"{outputPath}/{fileName}.jpg");
                    ...
                    default:
                        ...
                        res = Algo.BmpRleTransformation(image, $"{outputPath}/{fileName}.bmp");
                ...
                Console.WriteLine("Enter '1' to continue and another button to exit.");

                try
                {
                    int cd = Convert.ToInt32(Console.ReadLine().Trim());
                    Continue = cd == 1 ? true : false;
                }
                catch
                {
                    Continue = false;
